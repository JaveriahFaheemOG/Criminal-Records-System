<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WitnessInfo.aspx.cs" Inherits="DB_PROJECT.WitnessInfo" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Witness Record Entry</title>
    <style>
        body {
    ...
    <form id="form1" runat="server">
        <div class="outer-container">
            <div class="form-container">
                <h1>Add Witness Info</h1>

                <div class="form-row">
                    <label for="WitnessID">Witness ID</label>
                    <asp:TextBox ID="WitnessID" runat="server" TextMode="Number"></asp:TextBox>
                </div>
                ...
                <div class="form-row">
                    <label for="WitnessStatus">Witness Status</label>
                    <asp:TextBox ID="WitnessStatus" runat="server"></asp:TextBox>
                </div>
                ...
                <div class="form-row">
                    ...
                    <asp:TextBox ID="ContactDetails" runat="server" TextMode="number"></asp:TextBox>
                </div>
