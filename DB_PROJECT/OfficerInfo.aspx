<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficerInfo.aspx.cs" Inherits="DB_PROJECT.OfficerInfo" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Officer Record Entry</title>
    <style>
        body {
        ...
        <div class="outer-container">
            <div class="form-container">
                ...
                <div class="form-row">
                    ...
                    <asp:TextBox ID="BadgeNumber" runat="server"></asp:TextBox>
                </div>
                ...
                <div class="form-row">
                    ...
                    <asp:TextBox ID="Ranks" runat="server"></asp:TextBox>
                </div>

                <div class="form-row">
                    <label for="PhoneNumbers">Phone Numbers</label>
                    <asp:TextBox ID="PhoneNumbers" runat="server" TextMode="MultiLine" Rows="3"></asp:TextBox>
                </div>
